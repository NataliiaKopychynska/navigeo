...
function Button({ tittle, disabled = false, type = 'submit' }: Props) {
  return (
    <button
      type={type}
      className={`shadow-md flex gap-1 items-center justify-center pr-[8px] h-[40px] w-[456px] rounded-[10px] text-[16px] font-normal font-stretch-semi-expanded border-[1px] ${
        disabled
